...
if(isset($_POST) & !empty($_POST) & isset($_POST['NIC'])){
  ...
  if ($result->num_rows > 0) {
    ...
    echo'Date of Birth:<input type="date" name="DOB" value="'.$DOB.'" readonly><br><br>';
    ...
    echo'<form method="post" action="SavingsAccount1_new.php">';
    echo'<input type="hidden" name="NIC" value="'.$NIC.'"><br><br>';
