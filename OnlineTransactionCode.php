	  ...
	  while($row = $result->fetch_assoc()) {
		  ...
		  echo "Account Balance is insufficient";
              ...
              $sql = "SET autocommit = OFF;
				...
				INSERT INTO transaction_detail(Account_No,Amount,Withdraw,Detail,Teller) values ('" . $_POST["SenderAccNo"] . "','" . $_POST["amount"] . "',True,'Online','self');
                ...
                INSERT INTO transaction_detail(Account_No,Amount,Withdraw,Detail,Teller) values ('" . $_POST["RecipientAccNo"] . "','" . $_POST["amount"] . "',False,'Online','" . $_POST["SenderAccNo"] . "');
