...
if(isset($_POST) & !empty($_POST) & isset($_POST['NICs'])){
    ...
    //array_push($Other_branches,$_SESSION['Primary_Branch_ID']);
    foreach($Other_branches as $branch){
        $Branch_string=$Branch_string.$branch.',';
    }
    $Branch_Str=substr($Branch_string,0, -1);
    ...
    foreach($NIC_arr as $NIC){
        ...
        if ($result->num_rows > 0) {
            ...
            echo'Address Line 1:<input type="text" name="'.$NIC.'-adr1" value="'.$Address_Line_1.'" required><br><br>';
            echo'Address Line 2:<input type="text" name="'.$NIC.'-adr2" value="'.$Address_Line_2.'" required><br><br>';
            echo'Address Line_3:<input type="text" name="'.$NIC.'-adr3" value="'.$Address_Line_3.'" required><br><br>';
