	  ...
	  while($row = $result->fetch_assoc()) {
		  ...
		  echo "Account Balance is insufficient";
			  ...
			  $sql = "SET autocommit = OFF;
				...
				INSERT INTO transaction_detail(Account_No,Amount,Withdraw,Balance,Detail,Teller) values ('" . $_POST["AccNo"] . "','" . $_POST["amount"] . "',True,(SELECT balance from account WHERE Account_No='".$_POST["AccNo"] ."'),'ATM','".$_POST["ATM_No"]."');
